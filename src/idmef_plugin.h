...
//extern char idmef_message_setattr(idmef_t *, unsigned int);  //TODO: set some hooks by default
                                                               //(assoc w/ mandatory attrs)
//extern void idmef_message_wrattr(idmef_t *, unsigned int, unsigned char *, unsigned int);

extern char idmef_alert_addtag(idmef_alert_t *, unsigned int, void **);  //TODO: check compatibility in 
                                                                         //between classes(RFC4765)
