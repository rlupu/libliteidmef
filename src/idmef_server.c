			...
			while(1){
				...
				for(i = 0; i < rbytes;){
						...
						if(strncasecmp("IDMEF-Message", rbuff+i, 13) == 0){
							...
							if(current_tagbody == IDMEF_TAG_TARGET){				//TODO: check out corresp. attr is enabled
								...
								if(((idmef_target_t *)current_parenttag_0)->node_tag != NULL){	
									if(((idmef_target_t *)current_parenttag)->node_tag == NULL){		//create new node_tag
										idmef_target_addtag(((idmef_target_t *)current_parenttag), IDMEF_TAG_NODE | ((idmef_target_t *)current_parenttag_0)->node_tag->en_attrs, NULL);
									}
								...
								if(((idmef_source_t *)current_parenttag_0)->node_tag != NULL){	
									if(((idmef_source_t *)current_parenttag)->node_tag == NULL){		//create new node_tag
										idmef_source_addtag(((idmef_source_t *)current_parenttag), IDMEF_TAG_NODE | ((idmef_source_t *)current_parenttag_0)->node_tag->en_attrs, NULL);
									}
							...
							if(current_tagbody == IDMEF_TAG_ALERT){				//TODO: check out corresp. attr is enabled
								...
								if(((idmef_alert_t *)current_parenttag_0)->target_tag[0] != NULL){	
									...
									if(((idmef_alert_t *)current_parenttag)->target_tag[tn] == NULL){
										idmef_alert_addtag((idmef_alert_t *)current_parenttag, IDMEF_TAG_TARGET | ((idmef_alert_t *)current_parenttag_0)->target_tag[0]->en_attrs, NULL);
									}  else
							...
							if(current_tagbody == IDMEF_TAG_ALERT){				//TODO: check out corresp. attr is enabled
								...
								if(((idmef_alert_t *)current_parenttag_0)->source_tag[0] != NULL){
									...
									if(((idmef_alert_t *)current_parenttag)->source_tag[sn] == NULL){
										idmef_alert_addtag((idmef_alert_t *)current_parenttag, IDMEF_TAG_SOURCE | ((idmef_alert_t *)current_parenttag_0)->source_tag[0]->en_attrs, NULL);
									} else 
							...
							if(current_tagbody == IDMEF_TAG_NODE){
								...
								if( ((idmef_node_t *)current_parenttag_0)->address_tag[0] != NULL){
									...
									if(((idmef_node_t *)current_parenttag)->address_tag[an] == NULL){
										idmef_node_addtag((idmef_node_t *)current_parenttag, IDMEF_TAG_ADDR | ((idmef_node_t *)current_parenttag_0)->address_tag[0]->en_attrs, NULL);
									} else
							...
							if(current_tagbody == IDMEF_TAG_TARGET){
								...
								if(((idmef_target_t *)current_parenttag_0)->service_tag != NULL){ //check if service enabled
									if(((idmef_target_t *)current_parenttag)->service_tag == NULL)
										idmef_target_addtag( (idmef_target_t *)current_parenttag, IDMEF_TAG_SERVICE | ((idmef_target_t *)current_parenttag_0)->service_tag->en_attrs, NULL);
								...
								if(((idmef_source_t *)current_parenttag_0)->service_tag != NULL){ //check if service enabled
									if(((idmef_source_t *)current_parenttag)->service_tag == NULL)
										idmef_source_addtag( (idmef_source_t *)current_parenttag, IDMEF_TAG_SERVICE | ((idmef_source_t *)current_parenttag_0)->service_tag->en_attrs, NULL);
							...
							if(current_tagbody == IDMEF_TAG_CLASSIFICATION){	//TODO: check out corresp. attr is enabled
								...
								if( ((idmef_classification_t *)current_parenttag_0)->reference_tag[0] != NULL){ 
									unsigned char rn = ((idmef_classification_t *)current_parenttag)->references_no;//TODO:replace alerttag with parenttag
									if( ((idmef_classification_t *)current_parenttag)->reference_tag[rn] == NULL){
										idmef_classification_addtag((idmef_classification_t *)current_parenttag, IDMEF_TAG_REFERENCE | ((idmef_classification_t *)current_parenttag_0)->reference_tag[0]->en_attrs, NULL);
									} 
					...
					case IDMEF_PARSER_STATE_TAGEND_MESSAGE:
						((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len-1].iov_len = (rbuff+i+1) - prev_iovbase; 	//compute prev iov_len
					...
					case IDMEF_PARSER_STATE_ALERT0:
						if(strncasecmp("messageid", rbuff+i, 9) == 0){
							...
							((idmef_t *)ctxt)->alert_tag->messageid = (unsigned char **) &( ((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len].iov_base);
							((idmef_t *)ctxt)->alert_tag->messageid_len = (unsigned int *) &( ((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len].iov_len);
							*( ((idmef_t *)ctxt)->alert_tag->messageid_len) = 0;	//post-pone computation to the next attribute (safety)
					...
					case	IDMEF_PARSER_STATE_ANALYZER0:
						if(strncasecmp("name", rbuff+i, 4) == 0){
							...
							if( ((idmef_t *)ctxt)->alert_tag->analyzer_tag.en_attrs & IDMEF_ATTR_ANALYZER_NAME){
								...
								((idmef_t *)ctxt)->alert_tag->analyzer_tag.name_len = (unsigned int *) &( ((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len].iov_len);
								*( ((idmef_t *)ctxt)->alert_tag->analyzer_tag.name_len) = 0;	//post-pone computation to the next attribute (safety)
...
/*
							if( ((idmef_t *)ctxt)->alert_tag->createtime_tag.en_attrs & IDMEF_ATTR_CREATETIME_NTPSTAMP){
								((idmef_t *)ctxt)->alert_tag->createtime_tag.body = (unsigned char **) &( ((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len].iov_base);
								((idmef_t *)ctxt)->alert_tag->createtime_tag.body_len = (unsigned int *) &( ((idmef_t *)ctxt)->iov[((idmef_t *)ctxt)->iov_len].iov_len);
								*( ((idmef_t *)ctxt)->alert_tag->createtime_tag.body_len) = 0;	//post-pone computation to the next attribute (safety)
